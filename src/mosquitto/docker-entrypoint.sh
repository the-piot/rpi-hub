...
# create mosquitto pwfile
touch /mosquitto/config/pwfile
mosquitto_passwd -b /mosquitto/config/pwfile $MOSQUITTO_USERNAME $MOSQUITTO_PASSWORD

chmod 0700 /mosquitto/config/pwfile
chown --no-dereference mosquitto /mosquitto/config/pwfile
